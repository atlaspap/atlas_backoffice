...
Public Class ClsCategorias
    ...
    Public Shared Function Grava_Contador(ByVal pCod_Categoria As String) As Boolean
    ...
    Friend Shared Function GetNovoCodigo() As String
        ...
        Return "CAT-" & ClsEmpresas.GetContador(enCont.Categorias).ToString("00000") ' <-------------- VERIFICAR O Nº de ZEROS
    ...
    Public Shared Function GetCategorias() As List(Of ClsCategorias)
        ...
        mStrSQL += "ISNULL(Contador,'') As Contador,"
    ...
    Public Shared Function ModificaCategorias(ByVal pClsCategorias As ClsCategorias) As Boolean
        ...
        mCMD.Parameters.Clear()
        mCMD.Parameters.AddWithValue("@pCod_Categoria", pClsCategorias.Cod_Categoria.Substring(0, IIf(Len(pClsCategorias.Cod_Categoria) > 15, 15, Len(pClsCategorias.Cod_Categoria))))
        ...
        mCMD.Parameters.AddWithValue("@pCod_Imagem", pClsCategorias.Cod_Imagem.Substring(0, IIf(Len(pClsCategorias.Cod_Imagem) > 30, 30, Len(pClsCategorias.Cod_Imagem))))
        mCMD.Parameters.AddWithValue("@pContador", pClsCategorias.Contador)
    ...
    Public Shared Function GravaCategorias(ByVal pNovoCategorias As ClsCategorias) As Boolean
        ...
        mCMD.Parameters.AddWithValue("@pCod_Categoria", pNovoCategorias.Cod_Categoria.Substring(0, IIf(Len(pNovoCategorias.Cod_Categoria) > 15, 15, Len(pNovoCategorias.Cod_Categoria))))
        ...
        mCMD.Parameters.AddWithValue("@pCod_Imagem", pNovoCategorias.Cod_Imagem.Substring(0, IIf(Len(pNovoCategorias.Cod_Imagem) > 30, 30, Len(pNovoCategorias.Cod_Imagem))))
        mCMD.Parameters.AddWithValue("@pContador", pNovoCategorias.Contador)
