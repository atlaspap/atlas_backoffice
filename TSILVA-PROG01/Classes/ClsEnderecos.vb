...
Public Class ClsEnderecos
    ...
    ''' <summary>
    ''' GetEnderecos -> para ser usado na classe GetEntidades
    ''' </summary>
    ''' <param name="pCod_Entidade"></param>
    ''' <returns></returns>
    Public Shared Function GetEnderecos(ByVal pCod_Entidade As String) As List(Of ClsEnderecos)
        ...
        mListaEnderecos = Init_Lista_Enderecos(mCount, pCod_Entidade, mListaEnderecos)
        ...
        '            .Descritivo = "Endereço Principal"
        '            .Endereco = "Preencher aqui o 1º Endereço"
        '            .Cod_Postal = "7520-170"
        '            .Localidade = "Sines"
        '            .Data_Registo = -+
        '            .FLG_Ativo = True
    ...
    Friend Shared Function Init_Lista_Enderecos(ByVal pCount As Integer, ByVal pCod_entidade As String, ByVal pLista As List(Of ClsEnderecos)) As List(Of ClsEnderecos)

        For n As Integer = pCount To (20 + (pCount - 1))
            Dim mEndereco As New ClsEnderecos()
    ...
    '    mLista = mListaEnderecos.FindAll(Function(x) _
    ...
    Public Shared Function ModificaEnderecos(ByVal pClsEnderecos As ClsEnderecos) As Boolean
        ...
        mCMD.Parameters.AddWithValue("@pCod_Postal", pClsEnderecos.Cod_Postal.Substring(0, IIf(Len(pClsEnderecos.Cod_Postal) > 8, 8, Len(pClsEnderecos.Cod_Postal))))
        ...
        mStrSQL += "WHERE Cod_Entidade=@pCod_Entidade AND Cod_Endereco=@pCod_Endereco"
    ...
    Public Shared Function GravaEnderecos(ByVal pNovoEnderecos As ClsEnderecos) As Boolean
        ...
        mCMD.Parameters.AddWithValue("@pCod_Postal", pNovoEnderecos.Cod_Postal.Substring(0, IIf(Len(pNovoEnderecos.Cod_Postal) > 8, 8, Len(pNovoEnderecos.Cod_Postal))))
    ...
    Friend Shared Function Init_Lista(ByVal pCod_Entidade As String) As List(Of ClsEnderecos)
        Dim mReturn As New List(Of ClsEnderecos)

        Dim mEndereco As New ClsEnderecos
        With mEndereco
            .Cod_Entidade = pCod_Entidade
            .Cod_Endereco = "E01"
            .Descritivo = "Principal"
            .Endereco = "Escreva aqui o novo endereço..."
            .Cod_Postal = "7520-100"
            .Localidade = "Sines"
            .Data_Registo = Date.Now
            .FLG_Ativo = True
