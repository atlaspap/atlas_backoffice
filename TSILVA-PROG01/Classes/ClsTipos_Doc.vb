...
Public Class ClsTipos_Doc
    ...
    '''      (c) ETLA - PM-2024
    ''' </remarks>
    Public Shared Function GetTipos_Doc(ByVal Optional pFLG_ESC As String = "X") As List(Of ClsTipos_Doc)
        ...
        If ((pFLG_ESC = "S") Or (pFLG_ESC = "E") Or (pFLG_ESC = "C")) Then mCMD.Parameters.AddWithValue("@pFLG_ESC", pFLG_ESC)
        ...
        If ((pFLG_ESC = "S") Or (pFLG_ESC = "E") Or (pFLG_ESC = "C")) Then mStrSQL += "AND FLG_ESC=@pFLG_ESC"
