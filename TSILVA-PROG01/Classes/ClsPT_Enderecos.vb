...
Public Class ClsPT_Enderecos
    ...
    Public Shared Function GetCod_Postal() As List(Of String)
        Dim mListaCP As New List(Of String)
        ...
        mStrSQL = "SELECT "
        mStrSQL += "DISTINCT Cod_Postal "

        mStrSQL += "FROM PT_Enderecos "
        mStrSQL += "WHERE FLG_Ativo=1 "
        mStrSQL += "AND LEFT(Cod_Postal,1)='7' ORDER BY Cod_Postal"
        ...
        While mRDR.Read()
            ...
            mListaCP.Add(mClsPT_Enderecos.Cod_Postal)
    ...
    Public Shared Function GetPT_EnderecosByCod_Postal(ByVal pCod_Postal As String) As List(Of ClsPT_Enderecos)
